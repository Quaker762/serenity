...
{
#ifdef GL_DEBUG
    dbg() << "glPushMatrix(): Pushing matrix to the matrix stack (matrix_mode " << g_gl_state->curr_matrix_mode << ")\n";
#endif
    ...
    case GL_MODELVIEW:
        ...
        break;
    default:
        dbg() << "glPushMatrix(): Attempt to push matrix with invalid matrix mode " << g_gl_state->curr_matrix_mode << "\n";
        break;
    }
}
...
{
#ifdef GL_DEBUG
    dbg() << "glPopMatrix(): Popping matrix from matrix stack (matrix_mode = " << g_gl_state->curr_matrix_mode << ")\n";
#endif
    ...
    case GL_MODELVIEW:
        ...
        break;
    default:
        dbg() << "glPopMatrix(): Attempt to pop matrix with invalid matrix mode, " << g_gl_state->curr_matrix_mode << "\n";
        break;
    }
}
...
void glFrustum(GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble nearVal, GLdouble farVal)
{
    ...
    {
#ifdef GL_DEBUG
        dbg() << "glFrustum(): frustum created with curr_matrix_mode == GL_MODELVIEW!!!\n";
#endif
