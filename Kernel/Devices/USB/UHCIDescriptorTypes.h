...
#define TD_CONTROL_STATUS_ACTLEN (0x7ff)
#define TD_CONTROL_STATUS_ACTIVE_SHIFT (23)
#define TD_CONTROL_STATUS_INT_ON_COMPLETE_SHIFT (24)
#define TD_CONTROL_STATUS_ISOCHRONOUS_SHIFT (25)
#define TD_CONTROL_STATUS_LS_DEVICE_SHIFT (26)
#define TD_CONTROL_STATUS_ERR_CTR_SHIFT_SHIFT (27)
#define TD_CONTROL_STATUS_SPD_SHIFT (29)

#define TD_TOKEN_PACKET_ID_SHIFT (0)
#define TD_TOKEN_DEVICE_ADDR_SHIFT (8)
...
struct alignas(16) QueueHead {
    ...
    void set_transfer(USBTransfer* transfer)
    {
        m_transfer = transfer;
    }
...
private:
    ...
    Ptr32<USBTransfer> m_transfer { nullptr };        // Pointer to transfer linked to this queue head
