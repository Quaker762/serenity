...
using i8x64 = i8 __attribute__((vector_size(64)));
...
using i16x32 = i16 __attribute__((vector_size(64)));
...
using c8x64 = char __attribute__((vector_size(64)));
...
using u8x64 = u8 __attribute__((vector_size(64)));
...
using u16x32 = u16 __attribute__((vector_size(64)));
